...
public class RouteCreationStationManager
{
    ...
    private RouteCreationVehicleChoiceSubView _routeVehicleChooser;
    ...
    [SerializeField] private IUserNotificationView routeElementUserNotificationView;
    ...
    public TransportRouteCreationView RouteCreationView
    {
        set
        {
            _routeCreationView = value;
            _routeVehicleChooser = value.VehicleChoiceSubView;
            _settingController = value.SettingController;
            routeElementUserNotificationView = value.UserNotificationView;
    ...
    public void OnTransportStationClick(PathFindingNode pathFindingNode)
    {
        ...
        {
            routeElementUserNotificationView.InformationText = "Vehicle needs to be set first.";
            return;
        }
    ...
    private void AddNode(PathFindingNode pathFindingNode)
    {
        ...
        _settingController.RouteSettingProductSelectionView.VisibleGameObject.SetActive(true);
    }
